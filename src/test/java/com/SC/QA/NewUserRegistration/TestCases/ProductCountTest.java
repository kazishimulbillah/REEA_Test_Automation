...
public class ProductCountTest extends TestBase {
    ...
    @Test(priority = 1, dataProvider = "ProductsData")
    public void HomePageItemCount(String numberOfPhones, String numberOfLaptops, String numberOfMonitors) throws Throwable {

        extentTest = extent.startTest("ProductCount");

        homePage.ItemCount(numberOfPhones, numberOfLaptops, numberOfMonitors);
    }
    ...
    public void tearDown(ITestResult result) throws IOException {
        ...
        if (result.getStatus() == ITestResult.FAILURE) {
            ...
            String screenshotPath = ProductCountTest.getScreenshot(driver, result.getName());
